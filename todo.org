...
- [X] Create explorable places
  - [X] After exploration, places become an outpost 'P' excluding: IRON MINES
  ...
  - [X] A Deserted Town
  - [X] The Sulfur mine
  - [X] A Forgotten Battlefield
  - [X] A Ruined City
  - [X] A Huge Borehole
  - [X] A Crashed Ship
  - [X] A Murky Swamp

- [X] create roads/paths between explored outposts
- [X] going home maintains inventory across explorations
